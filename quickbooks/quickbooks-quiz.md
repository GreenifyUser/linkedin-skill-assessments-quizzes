...
- [x] Set the customer as inactive until they are an active customer.
...
- [x] You are required to encrypt your QuickBooks file.
...
- [x] Payroll Expense and Cash in Checking would be affected.
...
- [x] The diamond indicates that the list entry has open transactions.
