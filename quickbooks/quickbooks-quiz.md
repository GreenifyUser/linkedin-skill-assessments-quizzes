...
- [x] You can never delete a vendor, but you can make them inactive.
...
- [x] An inventory item has been received, but you have not received the corresponding bill.
...
- [x] Use the Lead Center bv clicking Company > Lead Center.
...
- [x] You are immediately prompted to back up the company file.
...
- [x] None, because timesheets are non-posting entries.
...
- [ ] a QuickBooks report in graphical form
- [ ] any QuickBooks report
- [x] a predesigned report that shows more detail about the data you are currently viewing on screen
- [ ] a snapshot of the Profit and Loss report
