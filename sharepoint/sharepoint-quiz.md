...
- [x] When a site is excluded from indexing, the subsites are still indexed.
...
- [x] The current group membership page provides shortcuts at the bottom of the page to other groups.
